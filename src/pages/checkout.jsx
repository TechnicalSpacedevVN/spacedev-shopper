                        ...
                        <div className="row">
                            <div className="col-12 col-md-7">
                                <div className="max-w-[300px] mb-5">
                                    <button className="btn btn-outline-dark btn-xs w-full">Quay trở lại giỏ hàng</button>
                                </div>
                                {/* Form */}
                                <form>
                                    {/* Heading */}
                                    ...
                                    <div className="list-group-item relative mb-5">
                                        ...
                                        <p className="font-size-sm mb-0 leading-[35px]">
                                            <a className="text-body text-xl font-bold " href="./product.html">Đặng Thuyền Vương</a> <br />
                                            <b>Số điện thoại:</b> 123456789 <br />
                                            <b>Email:</b>dangthuyenvuong@gmail.com<br />
                                            <b>Quận / Huyện:</b> 123456789 <br />
                                            <b>Tỉnh / thành phố:</b> 123456789 <br />
                                            <b>Địa chỉ:</b> 123456789 <br />
                                        </p>
                                        {/* Remove */}
                                        <div className="btn btn-outline-dark btn-xs absolute top-5 right-5" data-toggle="modal" href="#modalCheckoutAddress">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-12 col-md-6">
                                            <div className="form-group">
                                                ...
                                                <input className="form-control" id="mobilePhone" type="tel" placeholder="Phone Number*" required />
                                            </div>
                                        </div>
                                        <div className="col-12 col-md-6">
                                            <div className="form-group">
                                        ...
                                        <div className="col-12 col-md-6">
                                            <div className="form-group">
                                                ...
                                                <input className="form-control" id="companyName" type="text" placeholder="Province / City*" required />
                                            </div>
                                        </div>
                                        <div className="col-12">
                                            <div className="form-group">
